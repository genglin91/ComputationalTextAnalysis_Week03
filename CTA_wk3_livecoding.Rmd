...
barbie_oppenheimer <- rbind(barbie_posts, oppenheimer_posts)
table(barbie_oppenheimer$movie)
# add row number variable
barbie_oppenheimer <- barbie_oppenheimer %>%
...
```{r}
#creating corpus
corpus <- corpus(barbie_oppenheimer$Post.Text)
#assigning names to each document
docnames(corpus) <- barbie_oppenheimer$row_number
corpus
```
